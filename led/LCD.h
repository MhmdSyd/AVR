...
#define RS_DIR				DDRB_REG.BITS.BIT0
#define RS 						PORTB_REG.BITS.BIT0

/* RW PIN that control Read or Write from LCD */
#define RW_DIR				DDRB_REG.BITS.BIT1
#define RW						PORTB_REG.BITS.BIT1

/* E means enable that control enable data share between LCD and AVR or not */
#define E_DIR					DDRB_REG.BITS.BIT2
#define E						PORTB_REG.BITS.BIT2
...
#define SET_CURSOR_SECOND_LINE					0xC0
/*******************************************************************************
...
*/
void LCD_displayCustomChar (unsigned char char_data);
